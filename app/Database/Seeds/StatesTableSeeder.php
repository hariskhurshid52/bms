...
//
        ...
        $states = [
            array('id'=>1,'name' => "Azad kashmir", 'country_id' => 166),
            array('id'=>2,'name' => "Balochistan", 'country_id' => 166),
            array('id'=>3,'name' => "Fata", 'country_id' => 166),
            array('id'=>4,'name' => "Gilgit–baltistan", 'country_id' => 166),
            array('id'=>5,'name' => "Islamabad capital territory", 'country_id' => 166),
            array('id'=>6,'name' => "Khyber Pakhtunkhwa", 'country_id' => 166),
            array('id'=>7,'name' => "Punjab", 'country_id' => 166),
            array('id'=>8,'name' => "Sindh", 'country_id' => 166),
        ];
        $this->db->disableForeignKeyChecks();
        $this->db->table('states')->truncate();
