        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <h4 class="header-title">Reserved Short Codes</h4>
                    <div class="d-flex flex-column align-items-end">
                        <a href="<?= route_to('partner.shortCode.reserved') ?>" class="nav-link float-right">View All</a>
                ...
                <div class="table-responsive dashboard-widget">
                    <table class="table table-sm table-striped mb-0">
                        ...
                        <tbody>
                        <?php if (count($reserved) == 0): ?>
                            <tr>
                                <td colspan="4">
                                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                                        No reserved short codes found
                                    </div>
                                </td>
                            </tr>
                        <?php else: ?>
                            <?php foreach ($reserved as $shortCode): ?>
                                <tr>
                                    <td>
                                        <a href="<?= route_to('operator.schedules.order.create', $shortCode['shortCodeId']) ?>"><?= $shortCode['shortCode'] ?></a>
                                    </td>
                                    <td><a><?= $shortCode['partnerName'] ?></a></td>
                                    <td><a><?= ucfirst($shortCode['source']) ?></a></td>
                                    <td><a><?= $shortCode['createdAt'] ?></a></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
                        </tbody>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex flex-column align-items-end">
                        <a href="<?=route_to('partner.shortCode.orders.new.list')?>">To accept for processing</a>
                    ...
                    <table class="table table-sm table-striped mb-0">
                        ...
                        <?php else: ?>
                            <?php foreach ($newOrders as $shortCode): ?>
                                <tr>
                                    <td>
                                        <a href="<?= route_to('partner.shortCode.view', $shortCode['shortCodeId']) ?>"><?= $shortCode['shortCode'] ?></a>
                                    </td>
                                    <td><a><?= $shortCode['partnerName'] ?></a></td>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex flex-column align-items-end">
                        <a  href="<?=route_to('partner.shortCode.orders.inProgress.list')?>">To Go Live</a>
                ...
                <div class="tab-content">
                    <div class="tab-pane active show" id="tabAllShortCodeList">
                        <div class="table-responsive">
                            <table class="table table-sm" id="shortCodesTable">
                                <thead>
                                <tr>
...
<script>
    ...
    const initDataTable = () => {
        ...
        const table = $('#shortCodesTable').DataTable({
            ...
            ajax: {
                url: '<?= route_to("partner.dashboard.dtMediaTypeLiveShortCodes") ?>',
                type: 'POST',
                data: function (d) {
