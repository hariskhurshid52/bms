    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="card">
            <div class="card-body">
                ...
                <form method="post" action="<?= route_to('operator.users.save') ?>">
                    <?= csrf_field() ?>
                    <div class="row">
                        ...
                        <div id="notificationOnly"
                             class="col-md-12 row p-0 m-0 <?= !empty(old('role')) && old('role') !== 2 ? 'd-none' : '' ?>">
                            <div class="mb-2 col-md-6">
...
<script>
    $(document).ready(() => {
        $("#role").change(() => {
            ...
            if ($("#role").val() != 2) {
                $("#notificationOnly").hide()
            } else {
                $("#notificationOnly").show()
            }
        })
    })
</script>
