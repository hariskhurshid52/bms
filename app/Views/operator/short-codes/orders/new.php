        ...
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">
                    New Orders
                    <button class="btn btn-sm btn-primary pull-right" disabled id="btnMarkActive">Accept for Processing</button>
                </h4>
                <hr />
...
<script>
    $(document).ready(function () {
        $('#dtShortCodeOrders').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?= route_to('operator.shortCode.dtShortCodeNewOrdersList') ?>",
                type: "POST",
                dataType: "json",
                data: function (d) {
