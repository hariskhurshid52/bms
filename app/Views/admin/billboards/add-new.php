        ...
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Add New Hording 
                    <a href="<?= route_to('admin.billboard.list') ?>" class="btn btn-primary btn-sm pull-right">Go to list</a>
                </h4>
                <hr />
                ...
                <form method="POST" action="<?= route_to('admin.billboard.store') ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <textarea class="form-control" id="traffic_commming_from" name="traffic_commming_from"><?= old('traffic_commming_from'); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="number" class="form-control" id="contract_duration" name="contract_duration" value="<?= old('contract_duration', 1); ?>">
                        </div>
                        <div class="col-md-6 mb-2">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="text" class="form-control" id="authority_name" name="authority_name" value="<?= old('authority_name'); ?>">
                        </div>
                        <div class="col-md-6 mb-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="number" class="form-control" id="monthly_rent" name="monthly_rent" value="<?= old('monthly_rent'); ?>">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label for="annual_increase" class="form-label">Annual Increase (%)</label>
                            <input type="number" class="form-control" id="annual_increase" name="annual_increase" value="<?= old('annual_increase', 5); ?>">
                        </div>
