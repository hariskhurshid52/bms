...
<div class="row mt-4">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Update BillBoard Record<a href="<?= route_to('admin.billboard.list') ?>"
                        ...
                        <div class="row">
                                ...
                                <div class="mb-2">
                                    ...
                                    <select name="type" id="type" class="form-control" required>
                                        <?php foreach ($billboardTypes as $type): ?>
                                            <option <?=$billboard['billboard_type_id'] == $type['id'] ? 'selected' : ''?> value="<?= $type['id'] ?>"><?= $type['name'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="mb-2 mt-2">
                                    ...
                                    <select name="city" id="city" class="form-control select2" required>
                                        <?php foreach ($cities as $v): ?>
                                            <option <?=$billboard['city_id'] == $v['id'] ? 'selected' : ''?> value="<?= $v['id'] ?>"><?= $v['name'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-2 mt-2">
                                   ...
                                   <input type="text" class="form-control" id="area" name="area" value="<?=$billboard['area']?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-2 mt-2">
                                   ...
                                   <input type="text" class="form-control" id="address" name="address" value="<?=$billboard['address']?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group position-relative datepicker" id="picker_installation_date">
                                    <input autocomplete="off" data-provide="datepicker" data-date-format="yyyy-mm-dd"
                                        data-date-autoclose="true" data-date-container="#picker_installation_date"
                                        type="text" class="form-control" id="installation_date" name="installation_date"
