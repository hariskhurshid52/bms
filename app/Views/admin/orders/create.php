                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-2">
                                                        <label for="billboard" class="form-label">Select
                                                            Billboard</label>
                                                        <select class="form-control select2" id="billboard" data-placeholder="Select billboard"
                                                                name="billboard">
                                                            <option></option>
                                        ...
                                        <ul class="pager wizard list-inline mt-2">
                                            <li class="next list-inline-item float-end">
                                                <button type="button" class="btn btn-success"><i
                                                            class="mdi mdi-truck-fast me-1"></i> Proceed to Payments
                                                </button>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        <ul class="pager wizard list-inline mt-3">
                                            <li class="list-inline-item float-end">
                                                <button type="submit" class="btn btn-success"><i
                                                            class="mdi mdi-cash-multiple me-1"></i> Complete Order
                                                </button>
                                            </li>
                                        </ul>
                                    </div>
